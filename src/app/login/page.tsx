    ...
    <div className="flex min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
      ...
      <div className="hidden lg:flex lg:w-1/2 items-center justify-center bg-emerald-600 p-12">
        <div className="text-white space-y-6 max-w-md">
          ...
          <h2 className="text-4xl font-bold leading-tight">Plan Your Healthcare Costs with Confidence</h2>
          <p className="text-emerald-100 text-lg">
            Estimate medical costs, scan medicines for cheaper alternatives, and check government scheme eligibility — all in one platform.
          </p>
          <div className="space-y-3 pt-4">
            {["Medicine Scanner & Generic Alternatives", "AI-powered Cost Estimation", "Government Scheme Eligibility", "Insurance Coverage Calculator"].map(f => (
      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center p-6 md:p-12">
        <div className="w-full max-w-md space-y-8">
          ...
          <div>
            ...
            <p className="mt-2 text-gray-500 dark:text-gray-400">Sign in to your MediBudget account</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link href="/forgot-password" className="text-sm font-medium text-emerald-600 hover:text-emerald-700 dark:text-emerald-400 hover:underline">
                  Forgot password?
                </Link>
              </div>
              <input
          ...
          <p className="text-center text-sm text-gray-500 dark:text-gray-400">
            ...
            <Link href="/signup" className="font-semibold text-emerald-600 hover:text-emerald-700 dark:text-emerald-400 hover:underline">
              Sign up free
            </Link>
          </p>
        </div>
